  ...
  return (
    <div className="p-4 h-full flex flex-col">
      ...
      <div className="flex-1">
        ...
        {/* Compare leagues */}
        <div className="mb-4">
          <label htmlFor="compareLeagues" className="block text-sm font-medium mb-1">
            Compare Leagues (comma separated)
          </label>
          <input
            type="text"
            id="compareLeagues"
            name="compareLeagues"
            value={filters.compareLeagues ?? ""}
            onChange={handleChange}
            placeholder="e.g., Keepers, Settlers"
            className="input input-bordered input-primary w-full"
          />
          <div className="text-xs opacity-60 mt-1">
            表示名じゃなくて poe.ninja が認識する league キー（例: Keepers）を入れてね
          </div>
        </div>
